...
<p align="center">
  ...
  <a href="mailto:aniketagvane3232@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-Aniket%20Agvane-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=aniketagvane3232&label=Profile%20Views&color=0e75b6&style=flat" alt="Profile Views"/>
</p>
...
**EY Global Delivery Services & AICTE — Software Development Intern**

* 👥 Worked as part of a **3-member development team**.
* 🍔 Contributed to full-stack applications including **food delivery and auction applications**.
* 🎨 Developed **5+ frontend screens**.
* 🔌 Built and integrated **4+ backend API endpoints**.
* 🗄️ Worked with **MySQL data layers**.
* 🐛 Fixed **5+ functional and UI issues**.
* 🔄 Worked using **Agile development practices** across multiple sprints.
...
* 🧠 Semantic search and article analysis
...
**Tech:** JavaScript • C# • ASP.NET Core • AI • NLP • MySQL

---

#### 💬 Talkivo

Full-stack communication application consisting of frontend and backend services.

**Tech:** TypeScript • C# • ASP.NET Core • REST API

---

#### 🌱 PlantCare

Application focused on plant care and management.
...
Interactive data analytics project for exploring banking-related datasets.

**Tech:** Python • Jupyter Notebook • Pandas • Data Analytics • Power BI

---

#### 🎟️ EventEase

Event management application with separate client and server components.

**Tech:** JavaScript • C# • ASP.NET Core • REST APIs
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=vscode,visualstudio,pycharm,jupyter,postman,git,github,docker" />
</p>
...
I believe the best way to learn software development is by building real projects, experimenting with new technologies, and continuously improving.
